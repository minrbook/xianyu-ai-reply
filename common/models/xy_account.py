...
from common.utils.credential_crypto import EncryptedText, AccountMetadata
...
class XYAccount(TimestampMixin, Base):
    ...
    cookie: Mapped[str] = mapped_column(EncryptedText(), nullable=False, comment="Cookie信息")
    ...
    login_password: Mapped[str | None] = mapped_column(EncryptedText(), comment="登录密码")
    ...
    metadata_json: Mapped[dict[str, Any] | None] = mapped_column("metadata", AccountMetadata(), comment="元数据")
